sap.ui.define([
		...
		return BaseObject.extend("approve.req.customer.codan.model.ListSelector", {
			 ...
			 * @class
			 * @public
			 * @alias approve.req.customer.codan.model.ListSelector
			 */
			 ...
			 * @return {approve.req.customer.codan.model.ListSelector} the list selector object for method chaining
			 * @public
			 */
